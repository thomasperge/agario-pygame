...
class Menu:
    ...
    def create_buttons(self):
        ...
        play_keyboard_button = Button("Play with keyboard (P)", (self.screen.get_width() // 2, 200), "keyboard", "play")
        ...
        for i, diff in enumerate(difficulties):
            diff_button = Button(diff, (self.screen.get_width() // 2 + (i - 1) * 150, 400), diff.lower(), "difficulty")
    ...
    def draw(self):
        ...
        title_rect = title_text.get_rect(center=(self.screen.get_width() // 2, 350))
